...
1- Certifique-se de ter um arquivo CSV chamado data.csv no mesmo diretório onde está o script PHP. O arquivo CSV deve conter duas colunas de números.

2- Abra um terminal ou prompt de comando e navegue até o diretório onde está o arquivo prova.php.
